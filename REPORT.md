...
To get maximum performance, I opted to write my own `vector3` library using SIMD intrinsics. This improved render time from 2.4s to 1.8s, a 25% reduction.